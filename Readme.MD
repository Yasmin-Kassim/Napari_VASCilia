...
Explore the complexities of the cochlea with VASCilia, a Napari plugin created to aid in the 3D segmentation and quantification of stereocilia bundles. Equipped with a range of thoughtful features, VASCilia provides a supportive tool for auditory research, including:

Slice Selection: Easily navigate through 3D stacks to find the slices that matter most for your research.
Stack Rotation: Adjust the orientation of your stack to facilitate better analysis.
3D Instance Segmentation: Identify and assess individual bundles with clear separation.
Bundle Deletion: Remove unwanted bundles to streamline your dataset.
Regional Classification: Sort bundles into BASE, MIDDLE, or APEX categories.
Hair Cell Differentiation: Distinguish between Inner Hair Cells and Outer Hair Cells with confidence.
Measurement Analysis: Calculate various measurements such as volume, centroid location, and surface area.
Protein Intensity Analysis: Assess the intensity of proteins like EPS8 with detailed precision.
3D Distance Calculation: Measure the 3D distance from the peak to the base of each bundle, according to your sample's resolution.
